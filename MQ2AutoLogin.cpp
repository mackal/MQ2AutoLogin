...
PBYTE eqmainPattern = (PBYTE)"\x8B\x0D\x00\x00\x00\x00\x68\x00\x00\x00\x00\x51\xFF\xD6\x85\xC0\xA3\x00\x00\x00\x00\x75\x00\xFF\x15\x00\x00\x00\x00\x50\x68\x00\x00\x00\x00\xE8\x00\x00\x00\x00\x83\xC4\x00\x33\xC0\x5E\xC3";
char eqmainMask[] = "xx????x????xxxxxx????x?xx????xx????x????xx?xxxx";
...
PBYTE xwmPattern = (PBYTE)"\x8B\x15\x00\x00\x00\x00\x89\x82\x00\x00\x00\x00\xA1\x00\x00\x00\x00\x88\x98\x00\x00\x00\x00\x8B\x0D\x00\x00\x00\x00\x89\x1D\x00\x00\x00\x00\x8B\x11\xFF\x52\x00\x85\xC0\x74\x00";
char xwmMask[] = "xx????xx????x????xx????xx????xx????xxxx?xxx?";

PBYTE swmPattern = (PBYTE)"\xA1\x00\x00\x00\x00\x38\x98\x00\x00\x00\x00\x0F\x84\x00\x00\x00\x00\x8D\x88\x00\x00\x00\x00\x8B\x01\x3B\xC3\x74\x00\x89\x44\x24\x00\x33\xDB";
char swmMask[] = "x????xx????xx????xx????xxxxx?xxx?xx";

PBYTE xmldataPattern = (PBYTE)"\x8B\x54\x24\x00\x85\xD2\x56\x8B\x74\x24\x00\x8B\xC1\x75\x00\x85\xF6\x75\x00\x33\xC0\x5E\xC2\x00\x00";
char xmldataMask[] = "xxx?xxxxxx?xxx?xxx?xxxx??";

PBYTE lmousePattern = (PBYTE)"\x64\xA1\x00\x00\x00\x00\x6A\x00\x68\x00\x00\x00\x00\x50\x64\x89\x25\x00\x00\x00\x00\x83\xEC\x00\x53\x56\x8B\xF1\x8B\x46\x00\x85\xC0\x57\x74\x00\x51";
char lmouseMask[] = "xx????x?x????xxxx????xx?xxxxxx?xxxx?x";

PBYTE lcPattern = (PBYTE)"\xA3\x00\x00\x00\x00\x8B\x56\x00\x8B\x4A\x00\x6A\x00\x51\x52\x8B\xC8\xC7\x44\x24\x00\x00\x00\x00\x00\xE8\x00\x00\x00\x00";
char lcMask[] = "x????xx?xx?x?xxxxxxx?????x????";

PBYTE lcEGPattern = (PBYTE)"\x6A\x00\x68\x00\x00\x00\x00\x64\xA1\x00\x00\x00\x00\x50\x64\x89\x25\x00\x00\x00\x00\x83\xEC\x00\x56\x8B\xF1\x8D\x4C\x24\x00\xE8\x00\x00\x00\x00\x8B\x4C\x24\x00\x8B\x44\x24\x00\x8B\x54\x24\x00\x51";
char lcEGMask[] = "x?x????xx????xxxx????xx?xxxxxx?x????xxx?xxx?xxx?x";
...
bool FindCharacter(char *szName)
{
    ...
    {
        DWORD x = *(DWORD*)(((char*)pEverQuest)+0x38EA8);
        DWORD i = 0;
        do
        { 
